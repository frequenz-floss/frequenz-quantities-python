...
class ReactivePower(
    ...
    def __mul__(self, scalar: float, /) -> Self:
        """Scale this reactive power by a scalar.

        Args:
            scalar: The scalar by which to scale this reactive power.

        Returns:
            The scaled reactive power.
        """

    @overload
    def __mul__(self, percent: Percentage, /) -> Self:
        """Scale this reactive power by a percentage.

        Args:
            percent: The percentage by which to scale this reactive power.
    ...
    def __mul__(self, other: float | Percentage, /) -> Self:
        ...
        Args:
            other: The scalar or percentage by which to scale this reactive power.
    ...
    def __truediv__(self, other: float, /) -> Self:
        """Divide this reactive power by a scalar.

        Args:
            other: The scalar to divide this reactive power by.

        Returns:
            The divided reactive power.
        """

    @overload
    def __truediv__(self, other: Self, /) -> float:
        """Return the ratio of this reactive power to another.

        Args:
            other: The other reactive power.

        Returns:
            The ratio of this reactive power to another.
        """

    @overload
    def __truediv__(self, current: Current, /) -> Voltage:
        """Return a voltage from dividing this reactive power by the given current.

        Args:
            current: The current to divide by.

        Returns:
            A voltage from dividing this reactive power by a current.
        """

    @overload
    def __truediv__(self, voltage: Voltage, /) -> Current:
        """Return a current from dividing this reactive power by the given voltage.

        Args:
            voltage: The voltage to divide by.

        Returns:
            A current from dividing this reactive power by a voltage.
        """

    def __truediv__(
        self, other: float | Self | Current | Voltage, /
    ) -> Self | float | Voltage | Current:
        """Return a scaled reactive power, ratio, voltage, or current.

        Args:
            other: The scalar, reactive power, current or voltage to divide by.

        Returns:
            A scaled reactive power, a ratio, a voltage, or a current.
        """
